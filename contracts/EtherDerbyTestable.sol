...
contract EtherDerbyTestable {
    ...
    // FOR TESTING ONLY - DO NOT INCLUDE IN PRODUCTION CONTRACT
    bool shouldStartNextRound;
    ...
    function isRoundOver()
        ...
        returns (bool)
    {
        return block.timestamp >= roundEnds_ || shouldStartNextRound;
    }
